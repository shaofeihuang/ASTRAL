...
def tab_settings():
    ...
    with st.expander("LLM Model Settings", expanded=True):
        ...
        st.session_state['llm_max_tokens'] = st.slider("Max Tokens", 100, 1048576, st.session_state['token_limit'], 100, help="Set the maximum number of tokens for LLM responses. This limits the length of the generated output, which can help manage costs and ensure concise responses.")
